      ...
      <AnimatePresence>
        {isVisible && (
          ...
          >
            ...
            <div className="relative w-full max-w-7xl mx-3 sm:mx-4 laptop:mx-4 md:mx-6 mt-3 sm:mt-4 laptop:mt-4 md:mt-6">
              ...
              <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl">
                ...
                {/* Content Container */}
                <div className="relative flex items-center justify-between px-4 sm:px-6 laptop:px-6 md:px-8">
                  

                  
                  {/* Logo Section */}
                  <div className="flex items-center justify-center">
                    <div className="w-32 h-20 sm:w-40 sm:h-24 laptop:w-44 laptop:h-26 md:w-48 md:h-28 flex items-center justify-center">
                      <Logo showText={false} />
                    </div>
                  </div>
                ...
                <Link
                  to={item.path}
                          className={`relative flex items-center px-2 sm:px-3 laptop:px-3 md:px-4 py-1.5 sm:py-2 transition-all duration-300 font-medium text-xs sm:text-sm laptop:text-sm tracking-wide whitespace-nowrap rounded-xl sm:rounded-2xl group ${
                            isOverDarkSection 
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <Link to="/contact">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className={`hidden md:flex items-center space-x-1 sm:space-x-2 px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base transition-all duration-300 ${
                          isOverDarkSection 
                            ? 'text-white hover:text-gray-200' 
                    ...
                    <motion.button
                      ...
                      className={`md:hidden p-1.5 sm:p-2 transition-colors duration-300 rounded-lg sm:rounded-xl hover:bg-white/20 ${
                        isOverDarkSection 
                          ? 'text-white hover:text-gray-200' 
            ...
            <div className="md:col-span-2 lg:col-span-2 space-y-8 lg:col-start-1">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 pt-4 justify-center md:justify-start">
                ...
                <motion.a 
                  ...
                  className="group relative"
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:shadow-2xl transition-all duration-300 transform group-hover:-translate-y-1">
                    <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                    </svg>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur-sm"></div>
                </motion.a>
                ...
                <motion.a 
                  ...
                  className="group relative"
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-black via-gray-800 to-gray-900 rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:shadow-2xl transition-all duration-300 transform group-hover:-translate-y-1">
                    <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur-sm"></div>
                </motion.a>
                ...
                <motion.a 
                  ...
                  className="group relative"
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:shadow-2xl transition-all duration-300 transform group-hover:-translate-y-1">
                    <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-green-400 to-green-500 rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur-sm"></div>
                </motion.a>
              </div>
            </div>
